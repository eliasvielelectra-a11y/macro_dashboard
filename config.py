...
INDICATOR_COMPARISON_POLICY = {
    ...
    "overnight_deposit": {
        "comparison_mode": "snapshot_primary",
        "show_previous_period": True,
        "show_yoy": False,
        "show_snapshot": True,
    },
...
OFFICIAL_INDICATOR_CONFIG = OrderedDict({
    ...
    "core_inflation": {
        ...
        "unit": "%",
        "section": "egypt_reaction",
        "description": "Underlying inflation",
    },
    "overnight_deposit": {
        "title": "Overnight Deposit Rate",
        "tag": "Official",
        "frequency": "Event-based",
        "source": "CBE",
        "unit": "%",
        "section": "egypt_reaction",
        "description": "Policy corridor floor",
    },
    "overnight_lending": {
        "title": "Overnight Lending Rate",
        "tag": "Official",
        "frequency": "Event-based",
        "source": "CBE",
        "unit": "%",
        "section": "egypt_reaction",
        "description": "Policy corridor ceiling",
    },
    "main_operation": {
        "title": "Main Operation Rate",
        "tag": "Official",
        "frequency": "Event-based",
        "source": "CBE",
        "unit": "%",
        "section": "egypt_reaction",
        "description": "Main policy operation",
    },
    "conia": {
        "title": "CONIA",
        "tag": "Official",
        ...
        "unit": "%",
        "section": "egypt_reaction",
        "description": "Interbank overnight reference",
    },
...
SECTION_INDICATORS = {
    ...
    "egypt_reaction_row1": [
        "usd_egp", "egx30", "headline_inflation", "core_inflation"
    ],
    "egypt_reaction_row2": [
        "overnight_deposit", "overnight_lending", "main_operation", "conia"
    ],
    "external_inflows": [
